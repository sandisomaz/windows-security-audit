...
## System Map & Architecture Quick Link
...
2. **Launch via Windows Batch Script:**
   - Double-click **`START_HERE.bat`** (or right-click -> *Run as Administrator*).
...
|:---|:---:|:---|:---|
| **Quick** | 2-3 min | Essential checks: Memory, File System integrity, Active Processes | `FileSystemAudit`, `ProcessTriage` |
| **Standard** | 5-7 min | Core checks + Persistence vector hunting | Quick + `PersistenceHunting` |
| **Deep** *(Recommended)* | 10-15 min | Full security audit: Firewall, Defender, Hardening, Miners | Standard + `DefenderAudit`, `FirewallAudit`, `NetworkAudit`, `SystemHardening`, `CryptoMinerDetection` |
| **Forensic** | 20+ min | Comprehensive incident investigation: Browser artifacts, IOC matching, Hash calculation | Deep + `BrowserAudit`, `ThreatIntelligence` |
...
|-- Run-Tests.ps1          # Automated Pester Test Runner Script
|-- SYSTEM_MAP.md          # Comprehensive System Architecture & API Documentation
|-- LICENSE                # MIT License
|-- README.md              # Project Documentation
|
|-- Modules/               # Modular Security & Forensic Engines (.psm1)
|   |-- Core.psm1                  # State Engine, Logging & Weighted Risk Calculator
|   |-- ProcessTriage.psm1         # Process Injection, RAM Spikes & Unsigned Binaries
|   |-- PersistenceHunting.psm1    # WMI Subscriptions, Autoruns & Task Scanner
|   |-- CryptoMinerDetection.psm1  # Mining Signatures, Stratum Ports & CPU Utilization
|   |-- FileSystemAudit.psm1       # Disk Health & System File Integrity
|   |-- ForensicChecks.psm1        # HOSTS File, PUP Keywords & Backdoor Paths
|   |-- DefenderAudit.psm1         # Antivirus Definition Age & Real-Time Protection
|   |-- FirewallAudit.psm1         # Inbound/Outbound Rules & Open Port Auditing
|   |-- NetworkAudit.psm1          # TCP/UDP Connections & DNS Integrity
|   |-- SystemHardening.psm1       # UAC, Secure Boot, TPM 2.0, BitLocker & Credential Guard
|   |-- BrowserAudit.psm1          # Chrome/Edge/Firefox Extension Manifest Scanner
|   |-- ThreatIntelligence.psm1    # SHA256 Hashing, IOC Feeds & VirusTotal Integration
|   `-- ReportGenerator.psm1       # Multi-Format Report Engine (HTML/JSON/CSV)
|
...
## Understanding Security Reports & Risk Scores
...
- **LOW RISK (0% - 24%)**: System in good standing.
- **MEDIUM RISK (25% - 49%)**: Minor misconfigurations, remediation recommended.
- **HIGH RISK (50% - 100%)**: Critical vulnerabilities found, immediate action required.
